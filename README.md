...
Most AI fitness prompts produce generic advice. This skill produces a coaching system something calibrated so specifically to one athlete that no part of it could be copy-pasted to someone else.
...
The skill is sport-agnostic. The coach it builds is sport specific. There is no sientific proof that this work for everyone i tested the first version my self and it improved my running and strength scientifically
...
2. (skip this step if you dont want to use skill.md just add the skill.md to instruction instead) Go to customize and and manually add the skill (either through coping the skill.md text or draging the file over) name it Coach and then add it to your skills.  
3. Go back to your project, if you use a smartwatch or strava you can either download previus traning data and put it in project files or you could use a third party tool (e.g GetFast(kailo))
4. When your done with previus steps you write /Coach to use the skill and then add what you want the coach to do or just click enter. (Make sure you use the best model avalible for you and highest effort for best results)
...
Start a new conversation (or open your Project) and paste this:

```
/Coach I want to build my coaching system. Let's start from Phase 1.
```
...
- Should Tell you if your goal isn't reachable in the time you have — and propose a recalibrated version
...
It should and will not tell you what you want to hear just because you want to hear it.
